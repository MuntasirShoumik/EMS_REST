...
ActiveRecord::Schema[7.0].define(version: 2023_10_25_053250) do
  ...
  create_table "leave_counts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["employee_id"], name: "index_leave_counts_on_employee_id"
  end
  ...
  add_foreign_key "leave_counts", "employees", on_delete: :cascade
